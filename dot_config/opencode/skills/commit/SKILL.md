...
Also consider any user hints provided in the current message.
...
**Exception:** If the user's message contains `--yes` or `-y`, skip confirmation and execute immediately.
