...
-- -----------------------------------------------------------
-- -----------------------------------------------------------
-- This must come as early as possible
...
-- -----------------------------------------------------------
-- -----------------------------------------------------------
-- This is basically ui stuff but it changes everything so much
-- We put the config in core
local noice = ut.prequire('noice')
if noice then noice.setup() end
...
-- -----------------------------------------------------------
-- -----------------------------------------------------------
-- Image support (requires imagemagick)
-- -----------------------------------------------------------
-- -----------------------------------------------------------
-- -----------------------------------------------------------
local img = ut.prequire('image')
if img then
	img.setup({
		backend = "kitty",
